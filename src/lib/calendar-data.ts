...
export const EVENTS: RawEvent[] = [
  ...
  },
  {
    ...
    info: "Full-day certification course. Lunch provided. Successful participants receive a recognized food handler certificate. Registration is closed — please contact the Health Centre at (204) 367-9990 for sign-up info.",
    spots: 30, featured: true, requiresRegistration: true,
  },
  {
  ...
  },
  {
    ...
    category: "health", department: "health",
    contact: "(204) 367-9990",
    info: "Two-day wilderness first aid certification. Open to community members 16+. Certificate valid for 3 years. Registration is closed — please contact the Health Centre at (204) 367-9990 for sign-up info.",
    spots: 18, featured: true, requiresRegistration: true,
  },
  {
