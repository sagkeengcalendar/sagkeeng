...
export default function CalendarApp({ community }: { community: CommunityInfo }) {
  ...
  return (
    <div className="app-shell">
      ...
      {welcomeOpen && (
        <WelcomeModal community={community} persona={persona} onPick={setPersonaAndClose} onSkip={closeWelcome} />
      )}
    </div>
  );
}
...
function Hero({
  ...
  return (
    <header className="hero">
      <SmudgeCanvas className="hero__canvas" />
      <RotatingSlogans />
      <div className="hero__inner">
        <div className="hero__top">
          <div className="hero__crest">
            <img src={community.crestUrl || "/hero/crest.png"} alt={`${community.name} crest`} />
          </div>
          <div className="hero__titles">
            <div className="hero__nation">{community.name}</div>
            <h1 className="hero__title">Community Calendar</h1>
            <div className="hero__sub">{community.tagline}</div>
          </div>
        ...
        <div className="hero__strips">
          {weather && (
            <div className="strip">
              ...
              <div>
                <span className="strip__main">{weather.desc} · {community.name}</span>
  ...
  return (
    <div className="persona-pill">
      <button className="pchip" onClick={onViewPicks}>
        ✨ For {PERSONAS[persona].label.toLowerCase()}
      </button>
      <button className="pchip pchip--change" onClick={onChange}>
        Change
      </button>
      <button className="pchip pchip--x" onClick={onClear} aria-label="Show all events">
        All events
      </button>
    </div>
  );
    ...
    <div className="welcome is-open" role="dialog" aria-modal="true" aria-label="Welcome">
      ...
      <div className="welcome__box" ref={boxRef} tabIndex={-1}>
        ...
        <div className="welcome__mark">
          <img src={community.crestUrl || "/hero/crest.png"} alt="crest" style={{ width: 56, height: 56, objectFit: "contain" }} />
        </div>
        <div className="welcome__eyebrow">{community.name}</div>
        <h2 className="welcome__title">Boozhoo — welcome</h2>
...
function Footer({ community }: { community: CommunityInfo }) {
  return (
    <footer className="footer">
      ...
      <div className="footer__tag">miinawaa · again and again</div>
      <div className="footer__meta">
        {community.name}{community.tagline ? ` · ${community.tagline}` : ""}
      </div>
    </footer>
  );
}
